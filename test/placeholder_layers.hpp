...
public:
	...
	auto update(const std::chrono::milliseconds delta, auto&, auto&, auto&, auto&) -> void {
		MESSAGE("DUMP Updating {}", id, delta);
	}
	auto render(auto&, auto&, auto&) {}
	auto imgui_prepare(auto&, auto&, auto&, auto&) -> void {
	...
	auto event_callback(const sage::Event& event, auto&, auto&, auto&) -> void { MESSAGE("DUMP ", id, "got Event ", event); }
};
...
public:
	...
	auto event_callback(const sage::Event& event, auto&, auto&, auto&) -> void { MESSAGE("OTHER Layer \"", id, "\" got Event ", event); }
};
...
public:
	...
	auto event_callback(const sage::Event& event, auto&, auto&, auto&) -> void {
